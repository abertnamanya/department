...
public class DepartmentDaoTest extends BaseModuleContextSensitiveTest {
	...
	public void saveItem_shouldSaveAllPropertiesInDb() {
		...
		department.setDescription("good department");
		...
		//Then
		Department savedItem = dao.getDepartment(department.getDepartmentId());
		
		assertThat(savedItem, hasProperty("uuid", is(department.getUuid())));
		assertThat(savedItem, hasProperty("name", is(department.getName())));
		assertThat(savedItem, hasProperty("description", is(department.getDescription())));
	}
}
